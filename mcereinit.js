...
function mceInit(id, config) {
    ...
    var config = tinyMCE.extend(default_config, (config || {}), {
        ...
        content_css: [],
        content_style: "ul li, ol li {margin-bottom: 5px;} img {width:25px; height:10px; border: 1px dashed #000; padding:5px; display: inline-block;} .readthis {border: 1px dashed orange; padding: 5px;} #tinymce {padding: 10px;}",
        menubar: false,
